...
fetch('testimonials.json')
    ...
    .then(testimonials => {
        testimonials.map((testimonial) => {
            ...
            testimonialCard.className = `testimonial-card flex flex-col gap-4 bg-white p-[23px] rounded-lg border border-solid border-neutral-200 w-full h-fit break-inside-avoid `
